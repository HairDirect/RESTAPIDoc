...
a.off("all",this._onModelEvent,this)},_onModelEvent:function(a,b,c,d){if("add"!==a&&"remove"!==a||c===this){if("destroy"===a&&this.remove(b,d),"change"===a){var e=this.modelId(b.previousAttributes()),f=this.modelId(b.attributes);e!==f&&(null!=e&&delete this._byId[e],null!=f&&(this._byId[f]=b))}this.trigger.apply(this,arguments)}}});var w={forEach:3,each:3,map:3,collect:3,reduce:4,foldl:4,inject:4,reduceRight:4,foldr:4,find:3,detect:3,filter:3,select:3,reject:3,every:3,all:3,some:3,any:3,include:2,contains:2,invoke:0,max:3,min:3,toArray:1,size:1,first:3,head:3,take:3,initial:3,rest:3,tail:3,drop:3,last:3,without:0,difference:0,indexOf:3,shuffle:1,lastIndexOf:3,isEmpty:1,chain:1,sample:3,partition:3};h(t,w,"models");var x=["groupBy","countBy","sortBy","indexBy"];c.each(x,function(a){c[a]&&(t.prototype[a]=function(b,d){var e=c.isFunction(b)?b:function(a){return a.get(b)};return c[a](this.models,e,d)})});var y=b.View=function(a){this.cid=c.uniqueId("view"),c.extend(this,c.pick(a,A)),this._ensureElement(),this.initialize.apply(this,arguments)},z=/^(\S+)\s*(.*)$/,A=["model","collection","el","id","attributes","className","tagName","events"];c.extend(y.prototype,i,{tagName:"div",$:function(a){return this.$el.find(a)},initialize:function(){},render:function(){return this},remove:function(){return this._removeElement(),this.stopListening(),this},_removeElement:function(){this.$el.remove()},setElement:function(a){return this.undelegateEvents(),this._setElement(a),this.delegateEvents(),this},_setElement:function(a){this.$el=a instanceof b.$?a:b.$(a),this.el=this.$el[0]},delegateEvents:function(a){if(a||(a=c.result(this,"events")),!a)return this;this.undelegateEvents();for(var b in a){var d=a[b];if(c.isFunction(d)||(d=this[d]),d){var e=b.match(z);this.delegate(e[1],e[2],c.bind(d,this))}}return this},delegate:function(a,b,c){return this.$el.on(a+".delegateEvents"+this.cid,b,c),this},undelegateEvents:function(){return this.$el&&this.$el.off(".delegateEvents"+this.cid),this},undelegate:function(a,b,c){return this.$el.off(a+".delegateEvents"+this.cid,b,c),this},_createElement:function(a){return document.createElement(a)},_ensureElement:function(){if(this.el)this.setElement(c.result(this,"el"));else{var a=c.extend({},c.result(this,"attributes"));this.id&&(a.id=c.result(this,"id")),this.className&&(a["class"]=c.result(this,"className")),this.setElement(this._createElement(c.result(this,"tagName"))),this._setAttributes(a)}},_setAttributes:function(a){this.$el.attr(a)}}),b.sync=function(a,d,e){var f=B[a];c.defaults(e||(e={}),{emulateHTTP:b.emulateHTTP,emulateJSON:b.emulateJSON});var g={type:f,dataType:"json"};if(e.url||(g.url=c.result(d,"url")||M()),null!=e.data||!d||"create"!==a&&"update"!==a&&"patch"!==a||(g.contentType="application/json",g.data=JSON.stringify(e.attrs||d.toJSON(e))),e.emulateJSON&&(g.contentType="application/x-www-form-urlencoded",g.data=g.data?{model:g.data}:{}),e.emulateHTTP&&("PUT"===f||"DELETE"===f||"PATCH"===f)){g.type="POST",e.emulateJSON&&(g.data._method=f);var h=e.beforeSend;e.beforeSend=function(a){return a.setRequestHeader("X-HTTP-Method-Override",f),h?h.apply(this,arguments):void 0}}"GET"===g.type||e.emulateJSON||(g.processData=!1);var i=e.error;e.error=function(a,b,c){e.textStatus=b,e.errorThrown=c,i&&i.call(e.context,a,b,c)};var j=e.xhr=b.ajax(c.extend(g,e));return d.trigger("request",d,j,e),j};var B={create:"POST",update:"PUT",patch:"PATCH","delete":"DELETE",read:"GET"};b.ajax=function(){return b.$.ajax.apply(b.$,arguments)};var C=b.Router=function(a){a||(a={}),a.routes&&(this.routes=a.routes),this._bindRoutes(),this.initialize.apply(this,arguments)},D=/\((.*?)\)/g,E=/(\(\?)?:\w+/g,F=/\*\w+/g,G=/[\-{}\[\]+?.,\\\^$|#\s]/g;c.extend(C.prototype,i,{initialize:function(){},route:function(a,d,e){c.isRegExp(a)||(a=this._routeToRegExp(a)),c.isFunction(d)&&(e=d,d=""),e||(e=this[d]);var f=this;return b.history.route(a,function(c){var g=f._extractParameters(a,c);f.execute(e,g,d)!==!1&&(f.trigger.apply(f,["route:"+d].concat(g)),f.trigger("route",d,g),b.history.trigger("route",f,d,g))}),this},execute:function(a,b,c){a&&a.apply(this,b)},navigate:function(a,c){return b.history.navigate(a,c),this},_bindRoutes:function(){if(this.routes){this.routes=c.result(this,"routes");for(var a,b=c.keys(this.routes);null!=(a=b.pop());)this.route(a,this.routes[a])}},_routeToRegExp:function(a){return a=a.replace(G,"\\$&").replace(D,"(?:$1)?").replace(E,function(a,b){return b?a:"([^/?]+)"}).replace(F,"([^?]*?)"),new RegExp("^"+a+"(?:\\?([\\s\\S]*))?$")},_extractParameters:function(a,b){var d=a.exec(b).slice(1);return c.map(d,function(a,b){return b===d.length-1?a||null:a?decodeURIComponent(a):null})}});var H=b.History=function(){this.handlers=[],c.bindAll(this,"checkUrl"),"undefined"!=typeof window&&(this.location=window.location,this.history=window.history)},I=/^[#\/]|\s+$/g,J=/^\/+|\/+$/g,K=/#.*$/;H.started=!1,c.extend(H.prototype,i,{interval:50,atRoot:function(){var a=this.location.pathname.replace(/[^\/]$/,"$&/");return a===this.root&&!this.getSearch()},matchRoot:function(){var a=this.decodeFragment(this.location.pathname),b=a.slice(0,this.root.length-1)+"/";return b===this.root},decodeFragment:function(a){return decodeURI(a.replace(/%25/g,"%2525"))},getSearch:function(){var a=this.location.href.replace(/#.*/,"").match(/\?.+/);return a?a[0]:""},getHash:function(a){var b=(a||this).location.href.match(/#(.*)$/);return b?b[1]:""},getPath:function(){var a=this.decodeFragment(this.location.pathname+this.getSearch()).slice(this.root.length-1);return"/"===a.charAt(0)?a.slice(1):a},getFragment:function(a){return null==a&&(a=this._usePushState||!this._wantsHashChange?this.getPath():this.getHash()),a.replace(I,"")},start:function(a){if(H.started)throw new Error("Backbone.history has already been started");if(H.started=!0,this.options=c.extend({root:"/"},this.options,a),this.root=this.options.root,this._wantsHashChange=this.options.hashChange!==!1,this._hasHashChange="onhashchange"in window,this._useHashChange=this._wantsHashChange&&this._hasHashChange,this._wantsPushState=!!this.options.pushState,this._hasPushState=!(!this.history||!this.history.pushState),this._usePushState=this._wantsPushState&&this._hasPushState,this.fragment=this.getFragment(),this.root=("/"+this.root+"/").replace(J,"/"),this._wantsHashChange&&this._wantsPushState){if(!this._hasPushState&&!this.atRoot()){var b=this.root.slice(0,-1)||"/";return this.location.replace(b+"#"+this.getPath()),!0}this._hasPushState&&this.atRoot()&&this.navigate(this.getHash(),{replace:!0})}if(!this._hasHashChange&&this._wantsHashChange&&!this._usePushState){this.iframe=document.createElement("iframe"),this.iframe.src="javascript:0",this.iframe.style.display="none",this.iframe.tabIndex=-1;var d=document.body,e=d.insertBefore(this.iframe,d.firstChild).contentWindow;e.document.open(),e.document.close(),e.location.hash="#"+this.fragment}var f=window.addEventListener||function(a,b){return attachEvent("on"+a,b)};return this._usePushState?f("popstate",this.checkUrl,!1):this._useHashChange&&!this.iframe?f("hashchange",this.checkUrl,!1):this._wantsHashChange&&(this._checkUrlInterval=setInterval(this.checkUrl,this.interval)),this.options.silent?void 0:this.loadUrl()},stop:function(){var a=window.removeEventListener||function(a,b){return detachEvent("on"+a,b)};this._usePushState?a("popstate",this.checkUrl,!1):this._useHashChange&&!this.iframe&&a("hashchange",this.checkUrl,!1),this.iframe&&(document.body.removeChild(this.iframe),this.iframe=null),this._checkUrlInterval&&clearInterval(this._checkUrlInterval),H.started=!1},route:function(a,b){this.handlers.unshift({route:a,callback:b})},checkUrl:function(a){var b=this.getFragment();return b===this.fragment&&this.iframe&&(b=this.getHash(this.iframe.contentWindow)),b===this.fragment?!1:(this.iframe&&this.navigate(b),void this.loadUrl())},loadUrl:function(a){return this.matchRoot()?(a=this.fragment=this.getFragment(a),c.any(this.handlers,function(b){return b.route.test(a)?(b.callback(a),!0):void 0})):!1},navigate:function(a,b){if(!H.started)return!1;b&&b!==!0||(b={trigger:!!b}),a=this.getFragment(a||"");var c=this.root;(""===a||"?"===a.charAt(0))&&(c=c.slice(0,-1)||"/");var d=c+a;if(a=this.decodeFragment(a.replace(K,"")),this.fragment!==a){if(this.fragment=a,this._usePushState)this.history[b.replace?"replaceState":"pushState"]({},document.title,d);else{if(!this._wantsHashChange)return this.location.assign(d);if(this._updateHash(this.location,a,b.replace),this.iframe&&a!==this.getHash(this.iframe.contentWindow)){var e=this.iframe.contentWindow;b.replace||(e.document.open(),e.document.close()),this._updateHash(e.location,a,b.replace)}}return b.trigger?this.loadUrl(a):void 0}},_updateHash:function(a,b,c){if(c){var d=a.href.replace(/(javascript:|#).*$/,"");a.replace(d+"#"+b)}else a.hash="#"+b}}),b.history=new H;var L=function(a,b){var d,e=this;d=a&&c.has(a,"constructor")?a.constructor:function(){return e.apply(this,arguments)},c.extend(d,e,b);var f=function(){this.constructor=d};return f.prototype=e.prototype,d.prototype=new f,a&&c.extend(d.prototype,a),d.__super__=e.prototype,d};r.extend=t.extend=C.extend=y.extend=H.extend=L;var M=function(){throw new Error('A "url" property or function must be specified')},N=function(a,b){var c=b.error;b.error=function(d){c&&c.call(b.context,a,d,b),a.trigger("error",a,d,b)}};return b});var PrettyJSON={view:{},tpl:{}};PrettyJSON.util={isObject:function(a){return"[object Object]"===Object.prototype.toString.call(a)},pad:function(a,b){for(a=String(a);a.length<b;)a="0"+a;return a},dateFormat:function(a,b){return b=b.replace("YYYY",a.getFullYear()),b=b.replace("YY",String(a.getFullYear()).slice(-2)),b=b.replace("MM",PrettyJSON.util.pad(a.getMonth()+1,2)),b=b.replace("DD",PrettyJSON.util.pad(a.getDate(),2)),b=b.replace("HH24",PrettyJSON.util.pad(a.getHours(),2)),b=b.replace("HH",PrettyJSON.util.pad(a.getHours()%12,2)),b=b.replace("MI",PrettyJSON.util.pad(a.getMinutes(),2)),b=b.replace("SS",PrettyJSON.util.pad(a.getSeconds(),2))}},PrettyJSON.tpl.Node='<span class="node-container"><span class="node-top node-bracket" /><span class="node-content-wrapper"><ul class="node-body" /></span><span class="node-down node-bracket" /></span>',PrettyJSON.tpl.Leaf='<span class="leaf-container"><span class="<%= type %>"> <%=data%></span><span><%= coma %></span></span>',PrettyJSON.view.Node=Backbone.View.extend({tagName:"span",data:null,level:1,path:"",type:"",size:0,isLast:!0,rendered:!1,events:{"click .node-bracket":"collapse","mouseover .node-container":"mouseover","mouseout .node-container":"mouseout"},initialize:function(a){this.options=a,this.data=this.options.data,this.level=this.options.level||this.level,this.path=this.options.path,this.isLast=_.isUndefined(this.options.isLast)?this.isLast:this.options.isLast,this.dateFormat=this.options.dateFormat;var b=this.getMeta();this.type=b.type,this.size=b.size,this.childs=[],this.render(),1==this.level&&this.show()},getMeta:function(){var a={size:_.size(this.data),type:_.isArray(this.data)?"array":"object"};return a},elements:function(){this.els={container:$(this.el).find(".node-container"),contentWrapper:$(this.el).find(".node-content-wrapper"),top:$(this.el).find(".node-top"),ul:$(this.el).find(".node-body"),down:$(this.el).find(".node-down")}},render:function(){this.tpl=_.template(PrettyJSON.tpl.Node),$(this.el).html(this.tpl),this.elements();var a=this.getBrackets();return this.els.top.html(a.top),this.els.down.html(a.bottom),this.hide(),this},renderChilds:function(){var a=1;_.each(this.data,function(b,c){var d=a==this.size;a+=1;var e="array"==this.type?this.path+"["+c+"]":this.path+"."+c,f={key:c,data:b,parent:this,path:e,level:this.level+1,dateFormat:this.dateFormat,isLast:d},g=PrettyJSON.util.isObject(b)||_.isArray(b)?new PrettyJSON.view.Node(f):new PrettyJSON.view.Leaf(f);g.on("mouseover",function(a,b){this.trigger("mouseover",a,b)},this),g.on("mouseout",function(a){this.trigger("mouseout",a)},this);var h=$("<li/>"),i="&nbsp;:&nbsp;",j=$("<span />"),k=$("<span />").append(g.el);"array"==this.type?j.html(""):j.html(c+i),j.append(k),h.append(j),this.els.ul.append(h),g.parent=this,this.childs.push(g)},this)},isVisible:function(){return this.els.contentWrapper.is(":visible")},collapse:function(a){a.stopPropagation(),this.isVisible()?this.hide():this.show(),this.trigger("collapse",a)},show:function(){this.rendered||(this.renderChilds(),this.rendered=!0),this.els.top.html(this.getBrackets().top),this.els.contentWrapper.show(),this.els.down.show()},hide:function(){var a=this.getBrackets();this.els.top.html(a.close),this.els.contentWrapper.hide(),this.els.down.hide()},getBrackets:function(){var a={top:"{",bottom:"}",close:"{ ... }"};return"array"==this.type&&(a={top:"[",bottom:"]",close:"[ ... ]"}),a.bottom=this.isLast?a.bottom:a.bottom+",",a.close=this.isLast?a.close:a.close+",",a},mouseover:function(a){a.stopPropagation(),this.trigger("mouseover",a,this.path)},mouseout:function(a){a.stopPropagation(),this.trigger("mouseout",a)},expandAll:function(){_.each(this.childs,function(a){a instanceof PrettyJSON.view.Node&&(a.show(),a.expandAll())},this),this.show()},collapseAll:function(){_.each(this.childs,function(a){a instanceof PrettyJSON.view.Node&&(a.hide(),a.collapseAll())},this),1!=this.level&&this.hide()}}),PrettyJSON.view.Leaf=Backbone.View.extend({tagName:"span",data:null,level:0,path:"",type:"string",isLast:!0,events:{"mouseover .leaf-container":"mouseover","mouseout .leaf-container":"mouseout"},initialize:function(a){this.options=a,this.data=this.options.data,this.level=this.options.level,this.path=this.options.path,this.type=this.getType(),this.dateFormat=this.options.dateFormat,this.isLast=_.isUndefined(this.options.isLast)?this.isLast:this.options.isLast,this.render()},getType:function(){var a="string",b=this.data;return _.isNumber(b)?a="number":_.isBoolean(b)?a="boolean":_.isDate(b)?a="date":_.isNull(b)&&(a="null"),a},getState:function(){var a=this.isLast?"":",",b={data:this.data,level:this.level,path:this.path,type:this.type,coma:a};return b},render:function(){var a=this.getState();return"date"==a.type&&this.dateFormat&&(a.data=PrettyJSON.util.dateFormat(this.data,this.dateFormat)),"null"==a.type&&(a.data="null"),this.tpl=_.template(PrettyJSON.tpl.Leaf),$(this.el).html(this.tpl(a)),this},mouseover:function(a){a.stopPropagation();var b=this.path+'&nbsp;:&nbsp;<span class="'+this.type+'"><b>'+this.data+"</b></span>";this.trigger("mouseover",a,b)},mouseout:function(a){a.stopPropagation(),this.trigger("mouseout",a)}}),Handlebars.registerHelper("stringifyJSON",function(a,b){return new Handlebars.SafeString(JSON.stringify(a))}),Handlebars.registerHelper("toLower",function(a,b){return new Handlebars.SafeString(a.toLowerCase())}),Handlebars.registerPartial("p-category",Handlebars.template({1:function(a,b,c,d,e,f){var g,h=b.helperMissing,i=this.escapeExpression,j="function";return'<a class="loz" href="#action-'+i((b.toLower||a&&a.toLower||h).call(a,null!=f[1]?f[1].Name:f[1],{name:"toLower",hash:{},data:d}))+i((g=null!=(g=b.index||d&&d.index)?g:h,typeof g===j?g.call(a,{name:"index",hash:{},data:d}):g))+'">'+i((g=null!=(g=b.Name||(null!=a?a.Name:a))?g:h,typeof g===j?g.call(a,{name:"Name",hash:{},data:d}):g))+"</a>"},3:function(a,b,c,d,e,f){var g;return'        <li class="grid__item one-whole action">\r\n'+(null!=(g=this.invokePartial(c["p-action"],a,{name:"p-action",hash:{Category:f[1]},data:d,indent:"            ",helpers:b,partials:c}))?g:"")+"        </li>\r\n"},compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d,e,f){var g,h,i=b.helperMissing,j="function",k=this.escapeExpression;return"<div>\r\n    <h2>"+k((h=null!=(h=b.Name||(null!=a?a.Name:a))?h:i,typeof h===j?h.call(a,{name:"Name",hash:{},data:d}):h))+"</h2>\r\n    <span>"+k((h=null!=(h=b.Description||(null!=a?a.Description:a))?h:i,typeof h===j?h.call(a,{name:"Description",hash:{},data:d}):h))+"</span>\r\n    <div>Actions: "+(null!=(g=b.each.call(a,null!=a?a.Actions:a,{name:"each",hash:{},fn:this.program(1,d,0,e,f),inverse:this.noop,data:d}))?g:"")+'</div>\r\n    <ul class="grid action-list">\r\n'+(null!=(g=b.each.call(a,null!=a?a.Actions:a,{name:"each",hash:{},fn:this.program(3,d,0,e,f),inverse:this.noop,data:d}))?g:"")+"    </ul>\r\n</div>"},usePartial:!0,useData:!0,useDepths:!0})),Handlebars.registerPartial("p-action",Handlebars.template({1:function(a,b,c,d){var e;return"                <tr>\r\n"+(null!=(e=this.invokePartial(c["p-payload"],a,{name:"p-payload",data:d,indent:"                    ",helpers:b,partials:c}))?e:"")+"                </tr>\r\n"},3:function(a,b,c,d){var e;return"                <tr>\r\n"+(null!=(e=this.invokePartial(c["p-response"],a,{name:"p-response",data:d,indent:"                    ",helpers:b,partials:c}))?e:"")+"                </tr>\r\n"},compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d){var e,f,g=b.helperMissing,h=this.escapeExpression,i="function";return'<div class="card" id="action-'+h((b.toLower||a&&a.toLower||g).call(a,null!=(e=null!=a?a.Category:a)?e.Name:e,{name:"toLower",hash:{},data:d}))+h((f=null!=(f=b.index||d&&d.index)?f:g,typeof f===i?f.call(a,{name:"index",hash:{},data:d}):f))+'">\r\n    <h3>'+h((f=null!=(f=b.Name||(null!=a?a.Name:a))?f:g,typeof f===i?f.call(a,{name:"Name",hash:{},data:d}):f))+"</h3>\r\n    <span>Description: "+h((f=null!=(f=b.Description||(null!=a?a.Description:a))?f:g,typeof f===i?f.call(a,{name:"Description",hash:{},data:d}):f))+"</span><br />\r\n    <span>Endpoint: "+h((f=null!=(f=b.Endpoint||(null!=a?a.Endpoint:a))?f:g,typeof f===i?f.call(a,{name:"Endpoint",hash:{},data:d}):f))+"</span><br />\r\n    <span>Verb: "+h((f=null!=(f=b.Verb||(null!=a?a.Verb:a))?f:g,typeof f===i?f.call(a,{name:"Verb",hash:{},data:d}):f))+'</span>\r\n    <h4>Payload</h4>\r\n    <div class="table-wrapper">\r\n        <table class="table--bordered table--striped table--data">\r\n            <thead>\r\n                <tr><th>Name</th><th>Type</th><th>Notes</th></tr>\r\n            </thead>\r\n            <tbody>\r\n'+(null!=(e=b.each.call(a,null!=a?a.Payload:a,{name:"each",hash:{},fn:this.program(1,d,0),inverse:this.noop,data:d}))?e:"")+'            </tbody>\r\n        </table>\r\n    </div>\r\n    <h4>Response</h4>\r\n    <div class="table-wrapper">\r\n        <table class="table--bordered table--striped table--data">\r\n            <thead>\r\n                <tr><th>Name</th><th>Type</th><th>Notes</th></tr>\r\n            </thead>\r\n            <tbody>\r\n'+(null!=(e=b.each.call(a,null!=a?a.Response:a,{name:"each",hash:{},fn:this.program(3,d,0),inverse:this.noop,data:d}))?e:"")+'            </tbody>\r\n        </table>\r\n    </div>\r\n    <!--<h4>Test it</h4>\r\n    <button class="btn btn--gamma btn--secondary">Clear</button>\r\n    <button class="btn btn--gamma btn--positive btn--primary" data-endpoint="'+h((f=null!=(f=b.Endpoint||(null!=a?a.Endpoint:a))?f:g,typeof f===i?f.call(a,{name:"Endpoint",hash:{},data:d}):f))+'" data-verb="'+h((f=null!=(f=b.Verb||(null!=a?a.Verb:a))?f:g,typeof f===i?f.call(a,{name:"Verb",hash:{},data:d}):f))+"\" data-sample='"+h((b.stringifyJSON||a&&a.stringifyJSON||g).call(a,null!=a?a.SampleCall:a,{name:"stringifyJSON",hash:{},data:d}))+'\'>Execute</button>\r\n    <h5>Result</h5>\r\n    <code></code>-->\r\n    <div class="sample-response">\r\n        <h4>Sample Response</h4>\r\n        <div class="onoff">\r\n            <input type="checkbox" id="switch-'+h((b.toLower||a&&a.toLower||g).call(a,null!=(e=null!=a?a.Category:a)?e.Name:e,{name:"toLower",hash:{},data:d}))+h((f=null!=(f=b.index||d&&d.index)?f:g,typeof f===i?f.call(a,{name:"index",hash:{},data:d}):f))+'">\r\n            <label for="switch-'+h((b.toLower||a&&a.toLower||g).call(a,null!=(e=null!=a?a.Category:a)?e.Name:e,{name:"toLower",hash:{},data:d}))+h((f=null!=(f=b.index||d&&d.index)?f:g,typeof f===i?f.call(a,{name:"index",hash:{},data:d}):f))+'">\r\n                <span class="inner"></span>\r\n                <span class="switch"></span>\r\n            </label>\r\n        </div>\r\n        <pre style="display: none;"><code>'+(null!=(e=(b.stringifyJSON||a&&a.stringifyJSON||g).call(a,null!=a?a.SampleResponse:a,{name:"stringifyJSON",hash:{},data:d}))?e:"")+"</code></pre>\r\n    </div>\r\n</div>\r\n"},usePartial:!0,useData:!0})),Handlebars.registerPartial("p-payload",Handlebars.template({1:function(a,b,c,d){return" required"},compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d){var e,f,g=b.helperMissing,h="function",i=this.escapeExpression;return'<td data-label="Name" class="name'+(null!=(e=b["if"].call(a,null!=a?a.Required:a,{name:"if",hash:{},fn:this.program(1,d,0),inverse:this.noop,data:d}))?e:"")+'"><code>'+i((f=null!=(f=b.Name||(null!=a?a.Name:a))?f:g,typeof f===h?f.call(a,{name:"Name",hash:{},data:d}):f))+'</code></td>\r\n<td data-label="Type" class="type"><code>'+i((f=null!=(f=b.Type||(null!=a?a.Type:a))?f:g,typeof f===h?f.call(a,{name:"Type",hash:{},data:d}):f))+'</code></td>\r\n<td data-label="Notes" class="notes">'+i((f=null!=(f=b.Notes||(null!=a?a.Notes:a))?f:g,typeof f===h?f.call(a,{name:"Notes",hash:{},data:d}):f))+"</td>"},useData:!0})),Handlebars.registerPartial("p-response",Handlebars.template({compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d){var e,f=b.helperMissing,g="function",h=this.escapeExpression;return'<td data-label="Name"><code>'+h((e=null!=(e=b.Name||(null!=a?a.Name:a))?e:f,typeof e===g?e.call(a,{name:"Name",hash:{},data:d}):e))+'</code></td>\r\n<td data-label="Type"><code>'+h((e=null!=(e=b.Type||(null!=a?a.Type:a))?e:f,typeof e===g?e.call(a,{name:"Type",hash:{},data:d}):e))+'</code></td>\r\n<td data-label="Notes"><code>'+h((e=null!=(e=b.Notes||(null!=a?a.Notes:a))?e:f,typeof e===g?e.call(a,{name:"Notes",hash:{},data:d}):e))+"</code></td>"},useData:!0})),this.DAT=this.DAT||{},this.DAT["category-list"]=Handlebars.template({1:function(a,b,c,d){var e;return'<li id="category-'+this.escapeExpression((b.toLower||a&&a.toLower||b.helperMissing).call(a,null!=a?a.Name:a,{name:"toLower",hash:{},data:d}))+'" class="category">'+(null!=(e=this.invokePartial(c["p-category"],a,{name:"p-category",data:d,helpers:b,partials:c}))?e:"")+"</li>"},compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d){var e;return null!=(e=b.each.call(a,a,{name:"each",hash:{},fn:this.program(1,d,0),inverse:this.noop,data:d}))?e:""},usePartial:!0,useData:!0}),this.DAT["primary-navigation"]=Handlebars.template({1:function(a,b,c,d){var e,f=b.helperMissing,g=this.escapeExpression;return'        <li><a href="#category-'+g((b.toLower||a&&a.toLower||f).call(a,null!=a?a.Name:a,{name:"toLower",hash:{},data:d}))+'">'+g((e=null!=(e=b.Name||(null!=a?a.Name:a))?e:f,"function"==typeof e?e.call(a,{name:"Name",hash:{},data:d}):e))+"</a></li>\r\n"},compiler:[6,">= 2.0.0-beta.1"],main:function(a,b,c,d){var e;return'<label for="toggle-menu" class="toggle-menu" data-show-text="Show Menu" data-hide-text="Hide Menu">Show Menu</label>\r\n<input type="checkbox" id="toggle-menu" role="button">\r\n<nav id="primary-navigation">\r\n    <ul id="menu">\r\n'+(null!=(e=b.each.call(a,a,{name:"each",hash:{},fn:this.program(1,d,0),inverse:this.noop,data:d}))?e:"")+"    </ul>\r\n</nav>"},useData:!0}),Category=Backbone.Model.extend({defaults:{Name:"",Description:"",Actions:null}}),Categories=Backbone.Collection.extend({model:Category,fetch:function(a){var b=this;return a?a.Data?$.Deferred():$.getJSON(b.data_path,function(c){a.Data=c,b.set(c)}):void 0},data_path:"data.json"});var NavigationView=Backbone.View.extend({el:"#primary-navigation-container",events:{"click #toggle-menu":"toggleMenuClicked"},appContext:null,template:DAT["primary-navigation"],render:function(a){var b=this;b.$el.html(b.template(a))},toggleMenuClicked:function(a){var b=$(a.target),c=b.prev();c.text()===c.data("show-text")?c.text(c.data("hide-text")):c.text(c.data("show-text"))}}),CategoryListView=Backbone.View.extend({el:"#category-list",events:{"click .action .btn--primary":"actionPrimaryClicked","click .action .btn--secondary":"actionSecondaryClicked","change .action .sample-response input[type=checkbox]":"toggleSampleResponseClicked"},appContext:null,template:DAT["category-list"],render:function(a){var b=this;b.$el.html(b.template(a)),b.formatSampleResponse()},formatSampleResponse:function(){var a=this;a.$el.find(".sample-response pre > code").each(function(){var a=$(this),b=JSON.parse(a.html());a.html(JSON.stringify(b,null,2))})},actionPrimaryClicked:function(a){var b=$(a.target),c=b.text(),d=this;d.appContext&&d.appContext.Functions&&d.appContext.Data&&d.appContext.Data.Hosts&&d.appContext.Data.Categories&&(b.prop("disabled",!0).text("Running..."),d.appContext.Functions.ExecuteAjax(d.appContext.Data.Hosts[0].URL,b.data("endpoint"),b.data("verb"),b.data("sample")).done(function(a){if(a){new PrettyJSON.view.Node({el:b.siblings("code"),data:a})}b.prop("disabled",!1).text(c)}))},actionSecondaryClicked:function(){$(event.target).siblings("code").html("")},toggleSampleResponseClicked:function(a){var b=$(a.target),c=b.parent().siblings("pre");c&&c.length&&c.length>0&&c.slideToggle("slow")}});$(document).ready(function(){window.DocApp={Models:{},Collections:{Categories:new Categories},Views:{CategoryList:new CategoryListView,Navigation:new NavigationView},Router:{},Data:null,Settings:{amountScrolled:300,scrollDuration:1e3},Loaded:!1,Boot:function(){DocApp.Views.CategoryList.appContext=DocApp,DocApp.Functions.InitScrollToTop(),DocApp.Collections.Categories.fetch(DocApp).then(function(a){a&&a.Categories&&DocApp.Functions.ProcessCategories(a.Categories)})},Functions:{ProcessCategories:function(a){DocApp.Views.Navigation.render(a),DocApp.Views.CategoryList.render(a),DocApp.Functions.InitSmoothScroll()},ExecuteAjax:function(a,b,c,d){return jQuery.ajax({type:c,contentType:"application/json",url:a+b,dataType:"json",data:d?JSON.stringify(d):null})},InitScrollToTop:function(){var a=$("a.back-to-top");$(window).scroll(function(){$(window).scrollTop()>DocApp.Settings.amountScrolled?a.fadeIn(DocApp.Settings.scrollDuration):a.fadeOut(DocApp.Settings.scrollDuration)}),a.click(function(){return $("html,body").animate({scrollTop:0},DocApp.Settings.scrollDuration),!1})},InitSmoothScroll:function(){$("a[href*=#]:not([data-type=example-response])").click(function(){var a=$(this.hash);return a.length?($("html,body").animate({scrollTop:a.offset().top},DocApp.Settings.scrollDuration),!1):void 0})}}},DocApp.Boot()});